  ...
  <div id="addRoute" class="py-5">
    <div class="row justify-content-center" style="height: 100%">
      <div class="AddRouteContainer col-xl-5 col-md-6 col-sm-8 col-11">
        <div
          class="headerAddRouteContainer d-flex justify-content-between align-items-center"
        >
          <h4
            class="d-flex align-items-center ml-3 my-3"
          ...
          <svg
            ...
            height="25"
            fill="currentColor"
            class="bi bi-x-circle-fill my-2 mr-3 btnClose"
            viewBox="0 0 16 16"
          >
            <path
        ...
        <div class="bodyAddRoute" style="overflow: auto; height: 63vh">
          <div class="d-flex justify-content-center">
            <input
              ...
              v-model="firstUbication"
              placeholder="Ubicación iniial"
            />
            <p
          ...
          <div class="my-4 d-flex flex-column align-items-center">
            ...
            >
              <div
                ...
                style="position: absolute; width: 38vh; height: 38vh"
              >
                <button
                  @click="$store.dispatch('changeImgAction')"
                  class="btnRemove"
            ...
            <div class="my-4 d-flex justify-content-start" style="width: 100%">
              <button @click="uploadImg" class="btnUpload">Subir ruta</button>
            </div>
          </div>
        </div>
      </div>
