    ...
    <div id="addRoute">
        <div class="AddRouteContainer">
            <div class="headerAddRouteContainer d-flex justify-content-between align-items-center">
                ...
                <svg @click="alternateShowAddRoute()" style="color:white" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-x-circle-fill my-2 mr-3" viewBox="0 0 16 16">
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            uploadImg(){
                let name = '20210518190923320' + this.imgFile.name
                const refImg = refStorage.child('imagenes/' + name)
                const metaData = { contentType: 'img/*'}
                refImg.put(this.imgFile, metaData)
                .then(() => {
