    ...
    <div id="addRoute">
        <div class="AddRouteContainer">
            <div class="headerAddRouteContainer d-flex justify-content-between align-items-center">
                ...
                <svg @click="alternateShowAddRoute()" style="color:white" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-x-circle-fill my-2 mr-3 btnClose" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/>
                </svg>
            </div>
            <div class="bodyAddRoute" style="overflow:auto;">
                <div class="d-flex justify-content-center">
                    <input type="text" class="input-ubicacion" v-model="firstUbication" placeholder="Ubicación destino"/>
                ...
                <div class="my-4 d-flex flex-column align-items-center">
                    ...
                    <img v-if="img === null" src="../assets/sube_una_foto.jpg" style="width:80%;height:auto;" @click="onClick" />
                    <div v-else class="d-flex justify-content-center align-items-center" style="width:80vw;height:80vw;overflow:hidden;background:black;margin:0;">
                        <div class="d-flex justify-content-end" style="position:absolute;width:80vw;height:80vw;">
                        ...
                        <div class="d-flex justify-content-end align-items-end" style="position:absolute;width:80vw;height:80vw;">
...
<style scoped>
    ...
    .input-ubicacion:focus {
        border-bottom:1px solid #37f185;
        outline:none;
    }
