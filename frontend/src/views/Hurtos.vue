<template>
  <div>
    <header class="header">
      ...
      <div
        ref="outside"
        class="elementsHeader buttons logged menu"
        v-if="showAccount"
      >
        <div class="menuAccount">
          <button
            ...
            "
            class="botonesMenuAccount d-flex align-items-center"
          >
            <div
              class="p-2"
          ...
          >
            ...
            <div>
              <h5 class="ml-2" style="color: white; margin: 0">
                Cerrar sesión
              </h5>
            </div>
          </button>
      ...
      <div class="col-md-4 col-sm-6 mt-4">
        <div class="d-flex justify-content-end mt-3">
          <div style="width: 85%">
            ...
            <div
              class="ml-3 mt-5 text-justify"
              style="color: #adadad; width: 65%"
            >
              Unete y construyamos juntos una ciudad mucho más segura para
              todos.
            </div>
...
//component
import HurtoCard from "../components/HurtoCard";

export default {
  name: "Hurtos",
  components: { HurtoCard },
  data() {
    return {
      showAccount: false,
      interfaz: false,
