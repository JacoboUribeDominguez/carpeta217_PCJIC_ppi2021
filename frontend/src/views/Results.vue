    ...
    <div class="">
      <div class="row justify-content-center" style="width: 100%; margin: 0px">
        <div class="col-md-5 col-sm-8" style="padding: 0">
          <div
            class="m-4 d-flex justify-content-center align-items-center"
            v-if="!results"
            style="height: 250px"
          >
          ...
          <div v-else-if="results.length === 0">
            <div class="ifTherereNotResult">
              <h1 class="px-4">
                Resultados para
                <span class="px-2" style="background: #37f185">{{
                  searchedWord.toUpperCase()
                }}</span>
                <span style="font-size: 25px">({{ results.length }})</span>
              </h1>
            </div>
            <div class="mt-4">
          ...
          <div v-else>
            ...
            >
              <div class="publicacion">
                ...
                <p class="descripcionMeGusta">
                  {{ `${ruta.me_gusta} me gusta` }}
                </p>
              </div>
            </div>
          </div>
 ...
 * Observación: Muestra los resultados de las rutas, según lo colocado en el input del home.
 */
export default {
  name: "Results",
  computed: {
