<template>
  <div>
    ...
    >
      <div
        class="d-flex justify-content-center align-items-center col-md-8 col-12"
      ...
      >
        ...
        <div class="containerImgRef" v-else>
          <img
            ref="imgRef"
            :src="rutas[id].multimedia"
            :alt="rutas[id].id_ruta"
          />
        </div>
      </div>
      <div class="col-md-4 col-12" style="background: #212121; padding: 0">
        <div
          class="pt-3 pb-2 d-flex justify-content-between"
          style="color: #eeeeee"
        >
          <h4 class="d-flex align-items-center ml-3" style="margin: 0">
            {{ rutas[id] ? rutas[id].ubicacion : "" }}
          </h4>
          <svg
            @click="$router.push('/')"
            style="color: white"
            ...
            height="25"
            fill="currentColor"
            class="bi bi-x-circle-fill my-2 mr-3 btn-remove-rute"
            viewBox="0 0 16 16"
          >
            <path
        ...
        <div
          class="headerComments px-3 d-flex justify-content-start align-items-center pb-3"
          style="color: white"
        >
        ...
        >
          <div class="d-flex justify-content-center inputCommentContainer px-2">
            ...
            <div
              ...
              style="color: #37f185; transform: rotate(-45deg); opacity: 0.6"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
    ...
    <div
      style="height: 100vh; background: #212121"
 ...
 * Observación: Al dar click en cualquier ruta y darle al botón de comentario el código
 * almacena que ruta fue presionada, apartir de ello, consigue los datos, como la imagen,
 * el autor, y la descripción de la ruta. Esto gracias a estrucutras de datos como los condicionales
 * y funciones.
 */
export default {
  name: "Ruta",
  /**
   * Funcion que almacena y retorna data del aplicativo.
   * @returns {{cambiado: boolean, id: number}}
   */
  data() {
    return {
